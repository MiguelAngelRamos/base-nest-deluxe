...
export class InitialSchema1776681637179 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."appointments_status_enum" AS ENUM('scheduled', 'confirmed', 'cancelled', 'completed', 'no_show')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "doctor_specialties" ("doctor_id" uuid NOT NULL, "specialty_id" uuid NOT NULL, CONSTRAINT "PK_b9661cc766435ab56169b3fbe51" PRIMARY KEY ("doctor_id", "specialty_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a8c31ec7ac7398ea78c231d7bd" ON "doctor_specialties" ("doctor_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_fa46305c77b7a2db967573a469" ON "doctor_specialties" ("specialty_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "doctor_specialties" ADD CONSTRAINT "FK_a8c31ec7ac7398ea78c231d7bd8" FOREIGN KEY ("doctor_id") REFERENCES "doctors"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "doctor_specialties" ADD CONSTRAINT "FK_fa46305c77b7a2db967573a4695" FOREIGN KEY ("specialty_id") REFERENCES "specialties"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "doctor_specialties" DROP CONSTRAINT "FK_fa46305c77b7a2db967573a4695"`,
    );
    await queryRunner.query(
      `ALTER TABLE "doctor_specialties" DROP CONSTRAINT "FK_a8c31ec7ac7398ea78c231d7bd8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fa46305c77b7a2db967573a469"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a8c31ec7ac7398ea78c231d7bd"`,
    );
